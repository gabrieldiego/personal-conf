...
if [[ -z "$BACKUP_FILE" ]]; then
  safe_domain="${OVERWRITEHOST:-${DOMAIN:-nextcloud}}"
...
SOURCE_LOCAL_HTTP=${LOCAL_HTTP:-}
SOURCE_PUBLIC_DOMAIN=${PUBLIC_DOMAIN:-}
SOURCE_PUBLIC_PROTOCOL=${PUBLIC_PROTOCOL:-}
SOURCE_PUBLIC_URL=${PUBLIC_URL:-}
SOURCE_NEXTCLOUD_TRUSTED_DOMAINS=${NEXTCLOUD_TRUSTED_DOMAINS:-}
SOURCE_TRUSTED_PROXIES=${TRUSTED_PROXIES:-}
SOURCE_OVERWRITEHOST=${OVERWRITEHOST:-}
